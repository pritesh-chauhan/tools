...
<div class="container">
    ...
    <form action="admin.jsp" method="post">
        <input type="submit" value="Go Back" style="display: inline; text-align: justify; float: right;"/>
    </form>
</div>
<% 
    ...
    %>
        <tr>  
            <form action="update.jsp" method="post">
                <input type="hidden" name="old_id" value="<%= rs.getString("id")%>" />
                ...
                <input type="hidden" name="old_fullname" value="<%= rs.getString("fullname")%>" />
